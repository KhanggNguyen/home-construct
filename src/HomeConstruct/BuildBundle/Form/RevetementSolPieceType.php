...
class RevetementSolPieceType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ->add('type', EntityType::class, [
                ...
                'required' => false,
                'attr' => array(
                    'onchange'=>"updateInputRequiredRevetementSol()"
                )
            ])
            ->add('quantiteM2', IntegerType::class, [
                ...
                'attr' => array(
                    ...
                    'step'=>"1",
                    'min'=> '1',
                    'oninput'=>"updateInputRequiredRevetementSol()"
                )
            ])
            ->remove('prix')
            ->remove('secondOeuvre');
 ...
 */
    ...
    {
        return 'homeconstruct_buildbundle_revetement_solpiece';
    }
